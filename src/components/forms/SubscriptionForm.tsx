...
interface SubscriptionFormProps {
    ...
    defaultValues: NewSubscriptionFormData
    onSubmit: (data: NewSubscriptionFormData) => Promise<void>
    submitLabel: string
}

export default function SubscriptionForm({ accounts, defaultValues, onSubmit, submitLabel }: SubscriptionFormProps) {
